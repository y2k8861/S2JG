...
public class BoardService {
    ...
    //전체 글 출력 호출
    public BoardPageDto doGetBoardViewList( int page , int pageBoardSize ,int bcno, String Key ,String value){
        ...
        //3. 총 페이지 수
        //1. 전체게시물수
        int totalBoardSize = boardDao.getBoardSize( bcno , Key, value );
        //2. 총 페이지수 계산
        ...
        //4. 게시물 정보 요청
        List<BoardDto> list = boardDao.doGetBoardViewList( startRow,pageBoardSize , bcno , Key , value);
    ...
    public boolean doDeleteBoard( int bno ){
        ...
        return boardDao.doDeleteBoard(bno);
    }
